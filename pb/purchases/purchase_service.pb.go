...
var file_purchases_purchase_service_proto_rawDesc = []byte{
	...
	0x70, 0x75, 0x72, 0x63, 0x68, 0x61, 0x73, 0x65, 0x32, 0x98, 0x02, 0x0a, 0x0f, 0x50, 0x75, 0x72,
...
var file_purchases_purchase_service_proto_depIdxs = []int32{
	...
	4, // 8: purchases.PurchaseService.PurchaseCreate:output_type -> purchases.Purchase
	4, // 9: purchases.PurchaseService.PurchaseUpdate:output_type -> purchases.Purchase
	4, // 10: purchases.PurchaseService.PurchaseView:output_type -> purchases.Purchase
	2, // 11: purchases.PurchaseService.PurchaseList:output_type -> purchases.ListPurchaseResponse
